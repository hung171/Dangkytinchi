...
CREATE TABLE `tblmontienquyet` (
  ...
  `tblMonTienQuyetId` int(11) NOT NULL,
  KEY `fk_montienquyet_monhoc1` (`tblMonHocId`),
  KEY `fk_montienquyet_monhoc2` (`tblMonTienQuyetId`),
  CONSTRAINT `fk_montienquyet_monhoc1` FOREIGN KEY (`tblMonHocId`) REFERENCES `tblmonhoc` (`id`),
  CONSTRAINT `fk_montienquyet_monhoc2` FOREIGN KEY (`tblMonTienQuyetId`) REFERENCES `tblmonhoc` (`id`)
...
-- Dump completed on 2021-09-26 15:50:11
