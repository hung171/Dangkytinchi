...
CREATE TABLE `tblkihoc` (
  ...
  `tblNamHocId` int(11) NOT NULL,
  `tblHocKiId` int(11) NOT NULL,
  `danghoc` int(11) NOT NULL,
  `dangdk` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_kihoc_namhoc` (`tblNamHocId`),
  KEY `fk_kihoc_hocki` (`tblHocKiId`),
  CONSTRAINT `fk_kihoc_hocki` FOREIGN KEY (`tblHocKiId`) REFERENCES `tblhocki` (`id`),
  CONSTRAINT `fk_kihoc_namhoc` FOREIGN KEY (`tblNamHocId`) REFERENCES `tblnamhoc` (`id`)
...
INSERT INTO `tblkihoc` VALUES (1,1,1,0,0),(2,1,2,0,0),(3,1,3,0,0),(4,2,1,1,1),(5,2,2,0,1),(6,2,3,0,1);
