...
CREATE TABLE `tblketqua` (
  ...
  `tblDangKiHocId` int(11) NOT NULL,
  `tblMonHocDauDiemId` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_ketqua_dangkihoc` (`tblDangKiHocId`),
  KEY `fk_ketqua_monhocdaudiem` (`tblMonHocDauDiemId`),
  CONSTRAINT `fk_ketqua_dangkihoc` FOREIGN KEY (`tblDangKiHocId`) REFERENCES `tbldangkihoc` (`id`),
  CONSTRAINT `fk_ketqua_monhocdaudiem` FOREIGN KEY (`tblMonHocDauDiemId`) REFERENCES `tblmonhocdaudiem` (`id`)
...
-- Dump completed on 2021-09-26 15:50:08
