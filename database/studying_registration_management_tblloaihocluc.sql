...
--
-- Table structure for table `tblloaihocluc`
--

DROP TABLE IF EXISTS `tblloaihocluc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8 ;
CREATE TABLE `tblloaihocluc` (
...
--
-- Dumping data for table `tblloaihocluc`
--

LOCK TABLES `tblloaihocluc` WRITE;
/*!40000 ALTER TABLE `tblloaihocluc` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblloaihocluc` ENABLE KEYS */;
UNLOCK TABLES;
