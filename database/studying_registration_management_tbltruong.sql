...
CREATE TABLE `tbltruong` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_truong_diachi` (`tblDiaChiId`),
  CONSTRAINT `fk_truong_diachi` FOREIGN KEY (`tblDiaChiId`) REFERENCES `tbldiachi` (`id`)
...
INSERT INTO `tbltruong` VALUES (1,'PTIT','Học viện Công Nghệ Bưu Chính Viễn Thông',1);
