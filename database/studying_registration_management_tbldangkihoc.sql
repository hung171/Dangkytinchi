...
CREATE TABLE `tbldangkihoc` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_dangkihoc_sinhvienkhoa` (`tblSinhVienKhoaId`),
  KEY `fk_dangkihoc_lophocphan` (`tblLopHocPhanId`),
  CONSTRAINT `fk_dangkihoc_lophocphan` FOREIGN KEY (`tblLopHocPhanId`) REFERENCES `tbllophocphan` (`id`),
  CONSTRAINT `fk_dangkihoc_sinhvienkhoa` FOREIGN KEY (`tblSinhVienKhoaId`) REFERENCES `tblsinhvienkhoa` (`id`)
...
INSERT INTO `tbldangkihoc` VALUES (57,NULL,1,1),(58,NULL,1,6),(59,NULL,1,11),(60,NULL,1,16),(61,NULL,1,20);
