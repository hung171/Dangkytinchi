...
CREATE TABLE `tblmonhocdaudiem` (
  ...
  `tblDauDiemId` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_monhocdaudiem_daudiem` (`tblDauDiemId`),
  KEY `fk_monhocdaudiem_monhoc` (`tblMonHocId`),
  CONSTRAINT `fk_monhocdaudiem_daudiem` FOREIGN KEY (`tblDauDiemId`) REFERENCES `tbldaudiem` (`id`),
  CONSTRAINT `fk_monhocdaudiem_monhoc` FOREIGN KEY (`tblMonHocId`) REFERENCES `tblmonhoc` (`id`)
